    ...
    <main className="mt-24 bg-black px-4 py-16">
        <section className="bg-gray-300 text-center rounded-lg py-12 px-6 w-[80%] mx-auto">
          ...
          <form className="flex flex-col items-center justify-center space-y-2 pt-2 md:flex-row md:justify-between md:space-x-6 md:space-y-0">
            ...
            <button type="submit" className="bg-black text-white w-full py-2 rounded-md hover:bg-opacity-80 duration-200 hover:transition-all md:w-[40%]">Subscribe To our newsletter</button>
          </form>
        </section>
